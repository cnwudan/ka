...
$permanentUpgradeEnableLabel = $lang['runtime_permanent_upgrade_enable'] ?? '启用域名升级永久';
$permanentUpgradeEnableHint = $lang['runtime_permanent_upgrade_enable_hint'] ?? '开启后，用户可在域名列表将域名升级为永久有效。';
$permanentUpgradePriceLabel = $lang['runtime_permanent_upgrade_price'] ?? '域名升级永久费用（账户币种）';
$permanentUpgradePriceHint = $lang['runtime_permanent_upgrade_price_hint'] ?? '设置为 0 表示免费升级。';
$permanentUpgradeEnabledSetting = in_array($module_settings['enable_domain_permanent_upgrade'] ?? '0', ['1','on','yes','true'], true);
$permanentUpgradePriceSetting = (float) ($module_settings['domain_permanent_upgrade_price'] ?? 0);
...
<div class="card mb-4" id="runtime-control">
  <div class="card-body">
    ...
    <form method="post" class="row g-3 align-items-center">
      ...
      <div class="col-12 col-lg-4">
        <div class="form-check form-switch mb-2">
          <input class="form-check-input" type="checkbox" id="enable_domain_permanent_upgrade" name="enable_domain_permanent_upgrade" value="1" <?php echo !empty($permanentUpgradeEnabledSetting) ? 'checked' : ''; ?>>
          <label class="form-check-label" for="enable_domain_permanent_upgrade"><?php echo htmlspecialchars($permanentUpgradeEnableLabel); ?></label>
        </div>
        <small class="text-muted d-block mb-2"><?php echo htmlspecialchars($permanentUpgradeEnableHint); ?></small>
      </div>
      <div class="col-12 col-lg-4 col-xl-3">
        <label class="form-label" for="domain_permanent_upgrade_price"><?php echo htmlspecialchars($permanentUpgradePriceLabel); ?></label>
        <div class="input-group">
          <input type="number" class="form-control" id="domain_permanent_upgrade_price" name="domain_permanent_upgrade_price" min="0" step="0.01" value="<?php echo htmlspecialchars(number_format($permanentUpgradePriceSetting, 2, '.', '')); ?>">
        </div>
        <small class="text-muted d-block"><?php echo htmlspecialchars($permanentUpgradePriceHint); ?></small>
      </div>
