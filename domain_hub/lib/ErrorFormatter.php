        ...
        foreach ($rules as $rule) {
            foreach ($rule['keywords'] as $keyword) {
                if ($keyword !== '' && strpos($lower, $keyword) !== false) {
                    return $translate($rule['key'], $rule['message']);
                }
            }
        }

        return $clean !== '' ? $clean : $fallbackText;
    }
}
